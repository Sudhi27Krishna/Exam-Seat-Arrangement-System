...
export default function UeRow({date, branch, slot, subject}) {
    return (
        <tr className="bg-gray-100">
            ...
            <td className="text-center px-4 py-2">{date}</td>
            ...
            <td className="text-center px-4 py-2 rounded-tr-2xl rounded-br-2xl"><button className="text-red-500 hover:text-red-700">Delete</button></td>
        </tr>
    );
}