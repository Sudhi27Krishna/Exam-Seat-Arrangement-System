...
function NavBar() {
    return (
        <div class="flex flex-col w-64 h-screen bg-teal-900">
            <div class="flex flex-col items-center justify-center h-64">
                ...
                <p className="text-white mt-4">JOHN WICK</p>
            </div>
            <div class="flex flex-col items-start justify-start h-full py-5">
                <a href="/" class="text-white hover:bg-slate-900 py-2 px-6 w-full">
                    Home
                </a>
                <a href="/" class="text-white hover:bg-slate-900 py-2 px-6 w-full">
                    Manage Rooms
                ...
                <a href="/" class="text-white hover:bg-slate-900 py-2 pl-[5.75rem] w-full">
                    Log Out
                </a>
            </div>
        </div>
